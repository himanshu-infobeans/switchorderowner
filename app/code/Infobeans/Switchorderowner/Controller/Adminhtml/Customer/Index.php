...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $customerObj->addFieldToFilter('website_id', ['eq' => $storeId]);
        ...
        foreach ($customerObj as $customerObjdata) {
            $customerData = $this->customerFactory->create()->load($customerObjdata->getEntityId());
            $customerOptions = $customerOptions
                    . '<option value="' . $customerData->getId() . '">'
        ...
        $_result = ['customerOptions' => $customerOptions];
